					...
					<div class="mx-auto"
						...
						<img class="card-img-top img-thumbnail "
							...
							style="padding-left: 20px">叫了只鸡</span>
							   <span style="padding-left: 40%">订单提交成功，等待支付</span>
						<p>
						<p>
						...
						<p>
							<span style="padding-left: 20px;">订单编号:&nbsp;${orderid}</span>				
						     <!-- -在新窗口打开此界面 -->
						     <span style="padding-left: 25%"><a target="_blank" href="front/toPay" style="text-decoration: none;color: red">去支付</a></span> 
