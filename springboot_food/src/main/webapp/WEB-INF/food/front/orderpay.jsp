...
<body>
										...
										<c:forEach items="${alladdress }" var="address">
											...
											<div class="mx-auto changestyle " id="div${address.id }"
												...
												<ul
													...
													<li><label> &nbsp;&nbsp;</label><span
														class="address${address.id}">${address.address}</span><span
														style="padding-left: 50%" class="option"
														id="option${address.id }"></span></li>
												</ul>
											</div>
										</c:forEach>
	...
	<div class="modal fade" id="msgDialog" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<form:form id="addressform" method="post" action="front/addaddress" onsubmit="return submitaddress()" name="addressform"
	...
	<script type="text/javascript">
        ...
        if((name.length<1)||(phone.length<1)||(address.length<5))
            {
                alert("请完善信息！");
                return false;
            }
